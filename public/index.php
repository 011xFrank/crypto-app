    ...
    <section class="hero">
        <div class="container hero__inner">
            ...
            <h1 class="hero__title">
                Buy Crypto Instantly<br /><span>Paid via M-Pesa</span>
            </h1>
            <p class="hero__sub">
                Get any cryptocurrency at our guaranteed rates — delivered to your wallet within minutes.
                All prices in <strong>Kenyan Shillings (KES)</strong>.
            </p>
            ...
            <div class="hero__stats">
                <div class="stat">
                    <span class="stat__val">12+</span><span class="stat__label">Coins Available</span>
                </div>
                <div class="stat">
                    <span class="stat__val">~5 min</span><span class="stat__label">Avg Delivery</span>
                </div>
                <div class="stat">
                    <span class="stat__val">24/7</span><span class="stat__label">Support</span>
                </div>
            </div>
        </div>
            ...
            <div class="rates__grid">
                <?php foreach ($coins as $id => $info): ?>
                    <?php
                        ...
                        $priceDisplay = $p['kes_ours'] >= 1000 ? 'KES ' . number_format($p['kes_ours'], 2) : 'KES ' . number_format($p['kes_ours'], 4);
                    ?>
                    <div class="rate-card" data-coin="<?= $id ?>" onclick="selectCoin('<?= $id ?>')">
                        ...
                        <button class="btn btn--buy" onclick="selectCoin('<?= $id ?>'); event.stopPropagation();">
                            Buy <?= $info['symbol'] ?>
                        </button>
                    </div>
                <?php endforeach; ?>
        ...
        <div class="container">
            ...
            <div class="how__steps">
                <div class="step">
                    ...
                    <p>Pick your coin, enter the amount, and see the total in KES instantly.</p>
                </div>
                <div class="step__arrow">&#8594;</div>
                <div class="step">
                    <div class="step__num">2</div>
                    <h3>Confirm on WhatsApp</h3>
                    <p>Redirect to WhatsApp with pre-filled order details for payment instructions.</p>
                </div>
                <div class="step__arrow">&#8594;</div>
                <div class="step">
                    <div class="step__num">3</div>
                    <h3>Pay &amp; Receive</h3>
                    <p>Pay via M-Pesa. Your crypto lands in your wallet within minutes.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section buy" id="buy">
        <div class="container">
            <div class="section__header">
                ...
                <p>Fill in the form to complete the purchase via WhatsApp</p>
            </div>
            <div class="buy__wrap">
                <form method="POST" action="#buy" class="buy-form" id="buyForm">
                        ...
                        <div class="select-wrap">
                            <select name="coin" id="coin" required onchange="updateTotal()">
                                ...
                                <?php foreach ($coins as $id => $info): ?>
                                    ...
                                    <option value="<?= $id ?>" data-price="<?= $p['kes_ours'] ?>" data-symbol="<?= $info['symbol'] ?>">
                                        <?= $info['name'] ?> (<?= $info['symbol'] ?>) &mdash; KES <?= number_format($p['kes_ours'], 2) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-tag">
                            <input type="number" name="amount" id="amount" min="0.000001" step="any" placeholder="e.g. 0.01" required oninput="updateTotal()" />
                    ...
                    <button type="submit" class="btn btn--primary btn--full">
                        <span class="btn__wa-icon">&#128172;</span> Continue to WhatsApp
                    </button>
                </form>
                ...
                <div class="buy__info">
                    <div class="info-card">
                        ...
                        <ul>
                            ...
                            <li>&#10003; Fast delivery (< 10 mins)</li>
                            <li>&#10003; M-Pesa & Bank accepted</li>
    ...
    <footer class="footer">
        <div class="container footer__inner">
            ...
            <p class="footer__note">
                Prices via CoinGecko &middot; KES rate: <?= KES_RATE ?>/USD &middot; +5% fee
            </p>
        </div>
    </footer>
